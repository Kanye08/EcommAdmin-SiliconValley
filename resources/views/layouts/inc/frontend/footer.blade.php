<div>
    <div class="footer-area">
        <div class="container">
            <div class="row">
                <div class="col-md-3">
                    <h4 class="footer-heading">ADIL TECHNOLOGY</h4>
                ...
                <div class="col-md-3">
                    ...
                    <div class="mb-2">
                        <p>
                            <i class="fa fa-map-marker"></i> Tritek Consulting Limited
                        </p>
                    </div>
                    <div class="mb-2">
                    ...
                    <div class="mb-2">
                        <a href="" class="text-white">
                            <i class="fa fa-envelope"></i> siliconvalley@gmail.com
                        </a>
                    </div>
                </div>
            </div>
    ...
    <div class="copyright-area">
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <p class=""> &copy; 2023 - Tritek Consulting Limited. All rights reserved.</p>
                </div>
                <div class="col-md-4">
